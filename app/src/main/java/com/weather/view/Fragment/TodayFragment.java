...
public class TodayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(WeatherActivity.arrayList.size()!=0){
            MrgTemp.setText("Morning : "+WeatherActivity.arrayList.get(0).getMrgTemp()+" "+(char) 0x00B0 +"C");
            NightTemp.setText( "Night : "+WeatherActivity.arrayList.get(0).getNightTemp()+" "+(char) 0x00B0 +"C");
            dayTemp.setText("Day : "+WeatherActivity.arrayList.get(0).getDayTemp()+" "+(char) 0x00B0 +"C");
            place.setText("Location : "+WeatherActivity.arrayList.get(0).getAddress());
            humidity.setText("Humiditity : "+WeatherActivity.arrayList.get(0).getHumidity());
            pressure.setText("Pressure : "+WeatherActivity.arrayList.get(0).getPressure());
            Description.setText("Description : "+WeatherActivity.arrayList.get(0).getDescription());
            Cloud.setText("Cloud : "+WeatherActivity.arrayList.get(0).getCloud());
